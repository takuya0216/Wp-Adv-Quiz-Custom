...
class WpAdvQuiz_Helper_JsonQuestionImporter implements WpAdvQuiz_Helper_QuestionImpoterInterface
{
     ...
     *
     * @return WpAdvQuiz_Helper_JsonQuestionImporter|null
     */
    ...
    /**
     * @return WpAdvQuiz_Model_Question[] array
     */
    protected function buildQuestionModels()
    {
        ...
        foreach ($this->getQuestionsArray() as $question) {
            $model = new WpAdvQuiz_Model_Question(array_diff_key($question, array_flip(['answer_data'])));
    ...
    protected function buildAnswerModels($answerData)
    {
        ...
        foreach ($answerData as $answer) {
            $answers[] = new WpAdvQuiz_Model_AnswerTypes($answer);
        }
    ...
    {
        $helper = new WpAdvQuiz_Helper_QuestionImportDatabase($questions);
