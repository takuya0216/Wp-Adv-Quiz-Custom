...
class WpAdvQuiz_Helper_ExcelStatisticExporter implements WpAdvQuiz_Helper_StatisticExporterInterface
{
    ...
    protected function toExcel($array)
    {
		$data = $array;
    ...
    {
        return 'export_statistics_' . time() . '.xls';
    }
