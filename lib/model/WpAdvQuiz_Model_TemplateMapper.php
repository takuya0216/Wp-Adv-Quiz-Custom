...
class WpAdvQuiz_Model_TemplateMapper extends WpAdvQuiz_Model_Mapper
{

    /**
     * @param WpAdvQuiz_Model_Template $template
     * @return WpAdvQuiz_Model_Template
     */
    ...
    public function fetchAll($type, $loadData = true)
    {
        ...
        foreach ($result as $row) {
            ...
            $template = new WpAdvQuiz_Model_Template($row);

            if ($loadData && WpAdvQuiz_Helper_Until::saveUnserialize($data, $into)) {
    ...
    public function fetchById($templateId, $loadData = true)
    {
        ...
        return new WpAdvQuiz_Model_Template();
    }
}