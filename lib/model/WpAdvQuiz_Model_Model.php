...
class WpAdvQuiz_Model_Model
{

    /**
     * @var WpAdvQuiz_Model_QuizMapper
     */
...
// 			}
    ...
    /**
     *
     * @return WpAdvQuiz_Model_QuizMapper
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            $this->_mapper = new WpAdvQuiz_Model_QuizMapper();
        }
    ...
    /**
     * @param WpAdvQuiz_Model_QuizMapper $mapper
     * @return WpAdvQuiz_Model_Model
     */
