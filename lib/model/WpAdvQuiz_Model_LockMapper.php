...
class WpAdvQuiz_Model_LockMapper extends WpAdvQuiz_Model_Mapper
{
    protected $_table;
    ...
    /**
     * @param WpAdvQuiz_Model_Lock $lock
     *
     * @return false|int
     */
    public function insert(WpAdvQuiz_Model_Lock $lock)
    {
     ...
     * @param int $userId
     *
     * @return null|WpAdvQuiz_Model_Lock
     */
    public function fetch($quizId, $lockIp, $userId)
    {
        ...
        return $row !== null ? new WpAdvQuiz_Model_Lock($row) : null;
    }
