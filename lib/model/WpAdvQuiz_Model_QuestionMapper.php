...
class WpAdvQuiz_Model_QuestionMapper extends WpAdvQuiz_Model_Mapper
{
    private $_table;
    ...
    public function save(WpAdvQuiz_Model_Question $question, $auto = false)
    {
        $sort = null;

        if ($auto && $question->getId()) {
            $statisticMapper = new WpAdvQuiz_Model_StatisticMapper();
    ...
    public function fetch($id)
    {
        ...
        $model = new WpAdvQuiz_Model_Question($row);
    ...
    public function fetchById($id)
    {
        ...
        foreach ($results as $row) {
            $a[] = new WpAdvQuiz_Model_Question($row);
    ...
    public function fetchTable($quizId, $orderBy, $order, $search, $limit, $offset, $filter)
    {
        ...
        foreach ($results as $row) {
            $r[] = new WpAdvQuiz_Model_Question($row);
        }
